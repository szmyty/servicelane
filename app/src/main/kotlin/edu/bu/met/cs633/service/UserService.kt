...
class UserService(
    ...
    fun getUserFromAuthentication(authToken: AbstractAuthenticationToken): AdminUserDTO {
        ...
        log.warn("KEYCLOAK ATTRIBUTES: '$attributes'")
    ...
    companion object {
        ...
        private fun getUser(details: Map<String, Any>): User {
            ...
            if (details["phone"] != null) {
                user.phone = details["phone"] as String
            }
            if (details["userAddress"] != null) {
                user.address = details["userAddress"] as String
            }
            if (details["userCity"] != null) {
                user.city = details["userCity"] as String
            }
            if (details["userPostal"] != null) {
                user.postal = details["userPostal"] as String
            }
